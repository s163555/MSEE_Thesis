...
case State is
	...
	if prime_i = '0' then -- check if the caller has reset the prime bit
...
when pulse =>
	enable_o <= '1';
	prf_o <= '0'; -- let the pulse change sync with last edge of PWM
