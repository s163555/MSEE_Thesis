...
%	\gantttitle{9}{1}
	...
	\ganttgroup[inline=false]{Circuit and experiments}{1}{7} \\
	...
	\ganttbar[progress=100,progress label text={},inline=false]{Band-pass filter}{3}{4} \\
	\ganttbar[progress=100,progress label text={},inline=false]{Preamplifier, Demodulator, Low-pass filter}{4}{5} \\
	\ganttbar[progress=100,progress label text={},inline=false]{Sample-and-hold amplifier}{6}{7} \\
	\ganttbar[progress=100,progress label text={},inline=false]{High-pass filter}{6}{7} \\
	\ganttbar[progress=0,progress label text={},inline=false]{Unit testing}{1}{7}\\
	...
	\ganttbar[progress=0,progress label text={},inline=false]{Writing thesis report}{3}{8}\\
