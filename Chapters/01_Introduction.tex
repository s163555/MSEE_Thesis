...
%	\gantttitle{9}{1}
	...
	\ganttgroup[inline=false]{Embedded}{2}{7} \\
	...
	\ganttgroup[inline=false]{Experiments}{2}{6} \\
	\ganttbar[progress=25,progress label text={},inline=false]{Doppler experiments}{2}{4} \\
	\ganttgroup[inline=false]{Miscellaneous}{}{} \\
	\ganttbar[progress=0,progress label text={},inline=false]{Writing project report}{1}{8}\\
