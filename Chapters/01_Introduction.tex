...
\begin{ganttchart}[%Specs
	...
	\ganttbar[progress=10,inline=false, progress label text={}]{RTOS firmware development}{2}{5} \\
	\ganttbar[progress=0,progress label text={},inline=false]{Data processing platform}{3}{6} \\
