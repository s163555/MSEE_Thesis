...
%			Components & {\gls{prf} timer, bipolar pulser,\\quadrature demodulation,\\\gls{sha}} & {\gls{rf} amplifier,\\envelope detection,\\\gls{lp} filter, preamplifier, \gls{adc}} & {\gls{afg}, \gls{rf} amplifier,\\quadrature demodulation,\\\gls{sha}, \gls{bp} filter}\\
			...
			%Validation & In-vivo animal experiment & \gls{ml} evaluation using humans & Physiological simulator \\
			\bottomrule
		\end{talltblr}
	\end{adjustbox}%
\end{table}
