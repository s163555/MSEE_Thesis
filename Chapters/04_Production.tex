...
Some tips if you want good looking diagrams or graphs which will be inserted as pictures (e.g. in a figure environment with \textbackslash includegraphics): The main font is Arial. Use DTU colours as described in \cref{cha:introduction}. Use high quality pictures. Try to scale the diagram (picture) so the text size of the axis legends match the text size in this document.
...
\begin{mintedc}[list text={C-Programm!},title={Ein primitives C - Programm!}]
#include <stdio.h>
int main() 
{
