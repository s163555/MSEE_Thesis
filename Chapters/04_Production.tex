...
\begin{figure}[htbp]
	...
	\caption[Measured input and output of transmitter PCB]{Measured input and output of transmitter PCB. (Above) Input to gate driver with dead-time (Below) Output of power stage}
