\chapter{Analysis}
In the previous chapter every module was discussed in isolation and single-module experiments were conducted to validate their function. In this chapter various test setups will be discussed for the purpose of making multi-module experiments in the AFE and control system to evaluate their performance and compatibility.
