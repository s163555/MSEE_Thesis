...
\begin{figure}[htbp]
	...
	\caption[Flowchart of build stage I, pre-build]{Flowchart of \texttt{ninja} build stage I, pre-build}
	\label{fig:3_build1}
\end{figure}
...
\begin{figure}[htbp]
	...
	\caption[Flowchart of build stage II, generation and compilation]{Flowchart of \texttt{ninja} build stage II, generation and compilation}
	\label{fig:3_build2}
\end{figure}
...
\begin{figure}[htbp]
	...
	\caption[Flowchart of build stage III, intermediate binary]{Flowchart of \texttt{ninja} build stage III, intermediate binary}
	\label{fig:3_build3}
\end{figure}
...
\begin{figure}[htbp]
	...
	\caption[Flowchart of build stage IV, second intermediate binary]{Flowchart of \texttt{ninja} build stage IV, second intermediate binary}
	\label{fig:3_build4}
\end{figure}
...
\begin{figure}[htbp]
	...
	\caption[Flowchart of build stage V, final binary]{Flowchart of \texttt{ninja} build stage V, final binary}
	\label{fig:3_build5}
\end{figure}
...
\begin{figure}[htbp]
	...
	\caption[Flowchart of build stage VI, post-processing]{Flowchart of \texttt{ninja} build stage VI, post-processing}
	\label{fig:3_build6}
\end{figure}
