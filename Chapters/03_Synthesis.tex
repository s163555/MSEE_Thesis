...
\begin{figure}[htbp]
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\resizebox{\textwidth}{!}{%
		\begin{circuitikz}
			\draw (10,17) to[american,l={ \normalsize $V2$}] (10,15.75);
			\draw (10,15.75) to (10,15.5) node[ground]{};
			\draw [](10,17) to[short] (10,17.25);
			\draw (10,17.25) to[short] (11,17.25);
			\draw (13,17.25) to[C,l={ \normalsize $C2$}] (13,15.75);
			\draw (14.25,17.25) to[C,l={ \normalsize $C3$}] (14.25,15.75);
			\draw (11.75,17.25) to[R,l={ \normalsize $R2$}] (11.75,15.75);
			\draw [](11.75,15.75) to[short] (14.25,15.75);
			\draw (10,17.25) to[R,l={ \normalsize $R1$}] (11.75,17.25);
			...
			\draw [](18.25,16.75) to[short, -o] (18.5,16.75);
			\draw (17.75,15.5) to[C,l={ \normalsize $C4$}] (17.75,14.5);
	...
	\begin{subfigure}[b]{.49\textwidth}
		\resizebox{\textwidth}{!}{%
			\begin{circuitikz}
				...
				\draw (11,14.75) to (11,15) node[vcc]{\normalsize $V_{\mathrm{bias}}$};
			\end{circuitikz}
		}%
