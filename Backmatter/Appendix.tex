...
\begin{figure}[htbp]
	...
	\begin{adjustbox}{max width=\textwidth}
		...
		\begin{ganttchart}[%Specs
			...
			\ganttbar[progress=100,progress label text={},inline=false]{Active filter}{6}{7} \\
			\ganttbar[progress=100,progress label text={},inline=false]{Unit testing}{1}{7} \\
			\ganttmilestone[inline=false]{AFE complete}{7} \\
			\ganttgroup[inline=false]{Embedded}{4}{8} \\
			\ganttbar[progress=100,inline=false, progress label text={}]{Ultrasound pulser}{4}{7} \\
			\ganttbar[progress=100,progress label text={},inline=false]{Data processing}{8}{8} \\
			\ganttmilestone[inline=false]{Embedded design complete}{8} \\
			\ganttgroup[inline=false]{Miscellaneous}{1}{8} \\
			\ganttbar[progress=25,progress label text={},inline=false]{Doppler experiment}{5}{8} \\
			\ganttbar[progress=100,progress label text={},inline=false]{Transmitter experiment}{4}{5} \\
			\ganttbar[progress=100,progress label text={},inline=false]{Receiver experiment}{7}{8}\\
...
Latest sources and projects can be found at \cite{ultrasoundsystem_pcb,pynq_ultrasound_pulser,github_firmware}.
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\textwidth]{Figures/appendix/fpga/pwm_ultrasound_pulser1_removed.pdf}
	\caption{Jupyter Notebook running on PYNQ Z1 1}
	\label{fig:app_jupyter_notebook_1}
\end{figure}

\begin{figure}[htbp]
	\centering
	\includegraphics[width=\textwidth]{Figures/appendix/fpga/pwm_ultrasound_pulser2_removed.pdf}
	\caption{Jupyter Notebook running on PYNQ Z1 2}
	\label{fig:app_jupyter_notebook_2}
\end{figure}

\begin{figure}[htbp]
	\centering
	\includegraphics[width=\textwidth]{Figures/appendix/fpga/pwm_ultrasound_pulser3_removed.pdf}
	\caption{Jupyter Notebook running on PYNQ Z1 3}
	\label{fig:app_jupyter_notebook_3}
\end{figure}

\begin{figure}[htbp]
	\centering
	\includegraphics[width=\textwidth]{Figures/appendix/fpga/xadc_fft-1.pdf}
	\caption{XADC running on PYNQ Z1 1}
	\label{fig:app_xadc_notebook_1}
\end{figure}

\begin{figure}[htbp]
	\centering
	\includegraphics[width=\textwidth]{Figures/appendix/fpga/xadc_fft-2.pdf}
	\caption{XADC running on PYNQ Z1 2}
	\label{fig:app_xadc_notebook_2}
\end{figure}

\begin{figure}[htbp]
	\centering
	\includegraphics[width=\textwidth]{Figures/appendix/fpga/xadc_fft-3.pdf}
	\caption{XADC running on PYNQ Z1 3}
	\label{fig:app_xadc_notebook_3}
\end{figure}

\begin{figure}[htbp]
	\centering
	\includegraphics[width=\textwidth]{Figures/appendix/fpga/hier_ultrasound_pulser.pdf}
	\caption{Zynq Ultrasound Pulser block diagram}
	\label{fig:app_fpga_ultrasound_pulser}
\end{figure}
...
\begin{longlisting}
	\caption{pulser.m}
	\label{lst:pulser.m}
	\inputminted[bgcolor=LightGray,fontsize=\footnotesize,linenos,breaklines]{matlab}{Figures/appendix/matlab/pulser.m}
\end{longlisting}
