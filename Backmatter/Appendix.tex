...
\begin{figure}[htbp]
	\centering
	\includegraphics[height=.7\textheight]{Figures/appendix/fpga/pulser.pdf}
...
\begin{longlisting}
	\caption{Pulser.vhdl}
	\label{lst:Pulser.vhdl}
	\inputminted[bgcolor=LightGray,fontsize=\footnotesize,linenos,breaklines]{vhdl}{Figures/appendix/fpga/Pulser.vhdl}
\end{longlisting}
