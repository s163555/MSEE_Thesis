...
\begin{figure}[htbp]
	...
	\begin{adjustbox}{max width=\textwidth}
		...
		\begin{ganttchart}[%Specs
			...
			\ganttbar[progress=25,progress label text={},inline=false]{Doppler experiment}{2}{4} \\
			\ganttbar[progress=25,progress label text={},inline=false]{Transmitter experiment}{7}{8} \\
