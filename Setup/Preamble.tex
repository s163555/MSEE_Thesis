...
\usepackage[backend=biber,style=ieee,backref=true,abbreviate=false,dateabbrev=false,alldates=long,sorting=ynt,dashed=false,block=ragged]{biblatex} % Package for bibliography (citing)
