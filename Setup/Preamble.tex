...
\usepackage[backend=biber,style=ieee,abbreviate=true,dateabbrev=false,alldates=long,sorting=ynt,dashed=false,block=space,maxcitenames=3,maxbibnames=9,backref=false]{biblatex} % Package for bibliography (citing)
...
\usetikzlibrary{arrows.meta,chains,backgrounds,positioning,fit,petri}
